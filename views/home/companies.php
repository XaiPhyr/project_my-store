...
$result_companies = $CompanyModel->get_companies();
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <table class="table table-sm table-responsive-sm table-hover">
                ...
                <tbody class="">
                    <?php while ($item = mysqli_fetch_object($result_companies)) {
                        $count++;
                    ...
                    ?>
                        <tr>
                            ...
                            <td align="right">
                                <form style="display: inline-block" action="?page=add-company&id=<?php echo $item->company_id ?>&status=company" method="post">
